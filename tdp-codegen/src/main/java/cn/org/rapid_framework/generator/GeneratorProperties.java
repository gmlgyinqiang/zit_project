 ...
 * @author badqiu
 * @email badqiu(a)gmail.ywtraincomp
 */
public class GeneratorProperties {
	static PropertyPlaceholderHelper helper = new PropertyPlaceholderHelper("${", "}", ":", false);
	
	public static String PROPERTIES_FILE_NAMES[] = new String[]{"generator.xml"};
	...
	// 自动替换所有value从 ywtraincomp.company 替换为 ywtraincomp/company,并设置key = key+"_dir"后缀
...
//            }
	...
	public static void setProperties(Properties inputProps) {
        ...
        GLogger.println("[Auto Replace] [.] => [/] on generator.properties, key=source_key+'_dir', For example: pkg=ywtraincomp.company ==> pkg_dir=ywtraincomp/company  \n");

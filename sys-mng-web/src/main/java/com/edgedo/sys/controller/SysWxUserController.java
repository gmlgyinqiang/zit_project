...
@Controller
@RequestMapping("/admin/SYSWXUSER")
public class SysWxUserController extends BaseController {
	
	@Autowired
	private SysWxUserService service;
	...
	public ModelAndView listpage(@ModelAttribute SysWxUserQuery query){
	...
	public ModelAndView saveOrUpdate(SysWxUser voObj){
		ModelAndView modelAndView = new ModelAndView();
		String errMsg = "";
